...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <div class="viewport">
            ...
            <div class="header">
                ...
                <span class="header_title">资金明细</span>
            </div>
            <!--头部End-->
 ...
 <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                        <span><?php echo ($type[$vo['pursetype']]); ?></span>
                        <span>日期:2016-12-6</span>
                        <span></span>
                        <span>类型:<?php if($vo["status"] == 1): ?>收入<?php elseif($vo["status"] == 2): ?>支出<?php endif; ?></span>
                        <span><?php if($vo["status"] == 1): ?>收入<?php elseif($vo["status"] == 2): ?>支出<?php endif; ?>：￥<?php if($vo["status"] == 1): echo ($vo["sum"]); elseif($vo["status"] == 2): echo ($vo["export"]); endif; ?></if></span>

                        <span>余额:<?php echo ($vo["balance"]); ?></span>
                        <span>说明:<?php echo ($vo["explain"]); ?></span>
