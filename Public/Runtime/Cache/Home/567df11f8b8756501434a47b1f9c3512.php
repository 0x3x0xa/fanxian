...
<body style='background-color: #DCE0EB;'>
    <div class="" style='margin-left:15px;background: #fff;'>
        ...
        <form action="/index.php/Home/member/userinfo.html" method="post" class="form form-horizontal userinfo" id="form-member-add">
            ...
            <div class="pd-20">
                <table class="table  table-border table-bordered table-hover table-bg">
                    <tbody> 
                        ...
                        <tr>
                            <th class="text-r" style="width:30%">收益钱袋：</th>
                            <td class="text-l" style="width:70%"><?php echo ($userInfo["profit"]); ?></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <th class="text-r" style="width:30%" colspan="2">
                                <button type="button" class="btn btn-secondary radius" onclick="showPage('700','352','添加银行卡','<?php echo U("Member/addbank");?>')" href="javascript:;"><i class="Hui-iconfont"></i> 添加银行卡</button>
