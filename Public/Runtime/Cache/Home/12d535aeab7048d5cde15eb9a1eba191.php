...
<div class="page-container">
	<form action=""  class="form form-horizontal SubmiForm" id="form-article-add"  >
		{__TOKEN__}
                <div class="row cl">
			<label class="form-label col-xs-5 col-sm-4 " style="text-align: right;"><span class="c-red">*</span>选择银行：</label>
			<div class="formControls col-xs-6 col-sm-4">
				<select name="type" class="select type select-box"  nullmsg='请选择银行' datatype='*' >
		            ...
		            <div class="row cl">
			<label class="form-label col-xs-5 col-sm-4 " style="text-align: right;"><span class="c-red">*</span>开户姓名：</label>
			<div class="formControls col-xs-6 col-sm-4">
                            <input type="text" class="input-text name"  value="" placeholder="" id="" name="name"   nullmsg="请输入开户姓名！" datatype="*" >
			</div>
                           <div class="Validform_checktip"></div>
		</div>
                            <div class="row cl">
			<label class="form-label col-xs-5 col-sm-4 " style="text-align: right;"><span class="c-red">*</span>开户账号：</label>
			<div class="formControls col-xs-6 col-sm-4">
                 ...
                 <div class="row cl">
			<label class="form-label col-xs-5 col-sm-4 " style="text-align: right;"><span class="c-red">*</span>开户银行网点地址：</label>
			<div class="formControls col-xs-6 col-sm-4">
		...
		<div class="row cl">
			<label class="form-label col-xs-5 col-sm-4 " style="text-align: right;"><span class="c-red text-r">*</span>二级密码：</label>
			<div class="formControls col-xs-6 col-sm-4">
