    ...
    <body>
        <div class="viewport">
            ...
            <div class="header">
                ...
                <span class="header_title">我要理财</span>
            </div>
            <!--头部End-->

            <!--收益明细-->
            <div class="Licai_tip">
                <span>昨天总收益：<?php echo ($todaymoney); ?></span>
                <span>总金额：<?php echo ($allmoney); ?></span>
            </div>
            <!--收益明细end-->
            <!--内容-->
            <div class="Licai_list">
                <h3 style="margin:0px 4%;margin-bottom: 5px;border-bottom: 2px solid rgba(1, 28, 83, 0.72);padding-bottom: 10px;">邀请收益</h3>
                <ul style="margin: 0px 4%;">
                      <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                        <div class="Licai_topinfo">
                            <span class="Licai_money">订单号：<b style="color:#ff0000"><?php echo ($vo["order_no"]); ?></b></span>
                            <span class="Licai_datetime right_info">购买时间：<?php echo (date("Y-m-d ",$vo["create_date"])); ?></span>
                        </div>
                        <div class="Licai_bottominfo">
                            <span class="Licai_rate">利率：<?php echo ($vo["rate"]); ?>%</span>
                            <span class="Licai_sy right_info">收益：<b style="color:#ff0000"><?php echo ($vo["bonus"]); ?></b></span>
                        </div>
                          <div class="">
                            <span class="">描述：<?php echo ($vo["message"]); ?></span>
                        </div>
