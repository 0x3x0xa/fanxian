...
<nav class="breadcrumb" style='height: 45px;line-height: 45px;font-size: 16px;'>本金转出</nav>
        ...
        <div class="mt-0">
            <table class="table table-border table-bordered table-hover table-bg ">
                ...
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="text-c"> 
                        ...
                        <td class="text-c"><?php echo ($vo["day"]); ?></td>
                         <td class="text-c"><?php echo ($vo["rate"]); ?></td>
                         <td class="text-c"><?php echo ($vo["bonus"]); ?></td>
                          <td class="text-c"><?php echo ($vo["allbonus"]); ?></td>
                        <td class="text-c" style="width:120px;"><?php echo (date("Y-m-d H:i:s",$vo["create_date"])); ?></td>
                        <td class="text-c" style="width:120px;"> <a href='javascript:;'  style="color:blue" onclick="showPage('550','216','我要提现','<?php echo U('Report/tixian',array('id'=>$vo['id']));?>')"> 转出本金</a></td>
