    ...
    <body>
        <div class="viewport">
            ...
            <div class="Licai_list">
                <h3 style="margin:0px 4%;margin-bottom: 5px;border-bottom: 2px solid rgba(1, 28, 83, 0.72);padding-bottom: 10px;">收益明细</h3>
                <ul style="margin: 0px 4%;">
                      <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                        <div class="Licai_topinfo">
                            <span class="Licai_money">投资金额：<b style="color:#ff0000"><?php echo ($vo["money"]); ?></b></span>
                            <span class="Licai_datetime right_info">购买时间：<?php echo (date("m-d ",$vo["order_date"])); ?></span>
                        </div>
