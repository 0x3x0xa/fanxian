    ...
    <body>
        <div class="viewport">
            ...
            <div class="header">
                ...
                <span class="header_title">通知公告</span>
            </div>
            <!--头部End-->
            ...
            <div class="Notice_list">
                <ul>
                       <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                        <a href="<?php echo U('Home/Article/articlezhang/',array('id'=>$vo['id']));?>"> 
                            <span class="Notice_title"><?php echo (msubstr($vo["art_title"],0,12,'utf-8',true)); ?></span>
                            <span class="Notice_datetime"> <?php echo (date('Y-m-d ',$vo["art_time"])); ?></span>
                        </a>
