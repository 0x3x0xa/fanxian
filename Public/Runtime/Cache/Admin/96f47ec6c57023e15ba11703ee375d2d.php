...
<form method="post" action="/index.php/Admin/Article/index.html">
 ...
 &nbsp;&nbsp;&nbsp;&nbsp;
	...
	<a href="javascript:;" onClick='datadel("<?php echo U('Article/datadelArticle');?>")'  class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a>
	<a href="javascript:;" onClick="showPage('1050','','添加资讯','<?php echo U('Article/articleadd');?>')"  class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加资讯</a></span>
	...
	<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="text-c">
        ...
        <td class="text-l"><u style="cursor:pointer" class="text-primary" onClick="showPage('1050','','资讯编辑','<?php echo U('Article/articlezhang',array('id'=>$vo['id']));?>')"  title="查看">
         <?php echo ($vo["art_title"]); ?></u></td>
        ...
        <?php if($vo["art_status"] == 2 ): ?><td class="td-status"><span  class="label">已停用</span></td>
        <td class="f-14 td-manage">
            <a style="text-decoration:none" onClick="start(this,'<?php echo ($vo["id"]); ?>','<?php echo U('Article/article_start');?>','<?php echo U('Article/article_stop');?>')"  href="javascript:;" title=""><i class="Hui-iconfont">&#xe631;</i></a>
        <?php else: ?>
        <td class="td-status"><span class="label label-success">已启用</span></td>
        <td class="f-14 td-manage">
            <a style="text-decoration:none" onClick="stop(this,'<?php echo ($vo["id"]); ?>','<?php echo U('Article/article_stop');?>','<?php echo U('Article/article_start');?>')" href="javascript:;" title=""><i class="Hui-iconfont">&#xe6e1;</i></a><?php endif; ?>

	<a style="text-decoration:none" class="ml-5" onClick="showPage('1050','','资讯编辑','<?php echo U('Article/articleedit',array('id'=>$vo['id']));?>')" href="javascript:;" title="编辑">
        <i class="Hui-iconfont">&#xe6df;</i></a> 
        <a style="text-decoration:none" class="ml-5" onClick="del(this,'<?php echo ($vo["id"]); ?>','<?php echo U('Article/articleDel');?>')" href="javascript:;" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a></td><?php endforeach; endif; else: echo "" ;endif; ?>
