...
<div class="pd-20">
  <div class="text-c">
	...
	<option value="">全部显示</option>
        <?php if(is_array($type)): foreach($type as $key=>$vo1): ?><option value="<?php echo ($key); ?>" <?php if($arr['search_type'] == $key ): ?>selected<?php endif; ?>><?php echo ($vo1); ?></option><?php endforeach; endif; ?>
     </select> 
    </span>
      日期范围：
  ...
  <div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onClick='datadel("<?php echo U('Picture/datadelPicture');?>")' class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i>  批量删除</a> 
