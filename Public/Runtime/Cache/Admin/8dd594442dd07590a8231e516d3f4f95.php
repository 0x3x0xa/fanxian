...
<body>
    ...
    <form method="get" action="/index.php/Admin/Report/zijinlist.html">
        <div class="pd-20">
            <div class="text-c"> 
                ...
                <label><input name="search_status" value="1" type="radio" <?php if($arr['search_status'] == 1): ?>checked<?php elseif($_GET['search_status']== 1): ?>checked<?php endif; ?>>&nbsp;收入</label>&nbsp;
                <label><input name="search_status" value="2" type="radio" <?php if($arr['search_status'] == 2): ?>checked<?php elseif($_GET['search_status']== 2): ?>checked<?php endif; ?>>&nbsp;支出</label>&nbsp;
                <label>
        ...
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="text-c">
            ...
            <td><?php echo ($vo["mobile"]); ?></td>
             <td class="text-c"> 
                ...
                <td>
            <?php if($vo["status"] == 1): ?>收入<?php elseif($vo["status"] == 2): ?>支出<?php endif; ?></td>
