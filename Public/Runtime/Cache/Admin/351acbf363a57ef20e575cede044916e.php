...
<table class="table table-border table-bordered table-hover table-bg">
  <tbody>
    ...
    <tr>
     ...
     <tr>
      <th class="text-r" width="200">直推激励奖比例：</th><td><input type="text" name='ztjlj' placeholder="" value="<?php echo ($setparameter["ztjlj"]); ?>" style="width:200px" class="input-text lxsxf">%</td>
    </tr>
     <tr>
