...
<body>
    ...
    <form method="get" action="/index.php/Admin/Report/touzilist.html">
        <div class="pd-20">
            ...
            <label><input name="search_status" value="2" type="radio" <?php if($arr['search_status'] == 2): ?>checked='checked'<?php elseif($_GET['search_status']== 2): ?>checked='checked'<?php endif; ?>>&nbsp;完成</label>&nbsp;
