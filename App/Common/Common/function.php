...
//冻结日志
function freezelog($uid, $text, $type = 0, $admin_id) {
    $frozenlog_table = M('frozenlog');
    $id = $frozenlog_table->add(array('uid' => $uid, 'value' => $text, 'create_date' => time(), 'type' => $type, 'admin_id' => $admin_id));
    return $id;
}
...
function getCurrencyType() {
    $data = array('1' => '本金钱袋', '2' => '收益钱袋', '3' => '直接激励奖', '4' => '团队激励奖');
    return $data;
}
...
function getPictureType() {
    ...
    $data = array('1' => '自然风情', '2' => '人文风情', '3' => '建筑艺术');
    return $data;
}

function getBonusType() {
    $data = array('1' => '本金钱袋', '2' => '收益钱袋', '3' => '直接激励奖', '4' => '团队激励奖', '5' => '平台充值','6'=>'平台扣除','7'=>'提出本金','8'=>'拒绝提现');
    return $data;
}

function getChongzhiBonusStatus() {
    $data = array('1' => '处理中', '2' => '充值成功', '3' => '充值失败');
    return $data;
}

function getTixianBonusStatus() {
    $data = array('1' => '处理中', '2' => '提现成功', '3' => '提现失败');
    return $data;
}
function purseType(){
     $data = array('1' => '本金钱袋', '2' => '收益钱袋');
     return $data;
}
